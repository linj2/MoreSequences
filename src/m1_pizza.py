...
def run_test_draw_points_on_circle():
    ...
    # ------------------------------------------------------------------
    # TODONE: 3. Implement this TEST function.
...
def run_test_pizza():
    ...
    # ------------------------------------------------------------------
    # TODONE: 5. Implement this TEST function.
...
def pizza(window, circle, number_of_slices, color, thickness):
    ...
    # ------------------------------------------------------------------
    circle.attach_to(window)
    pt = generate_points_on_circle(circle, number_of_slices)
    for k in range(len(pt)):
        line = rg.Line(pt[k],circle.center)
...
def run_test_polygon():
    ...
    # ------------------------------------------------------------------
    # TODONE: 7. Implement this TEST function.
...
def polygon(window, circle, number_of_segments, color, thickness):
    ...
    # ------------------------------------------------------------------
    circle.attach_to(window)
    pt = generate_points_on_circle(circle, number_of_segments)
    for k in range(len(pt)):
        line = rg.Line(pt[k], pt[k-1])
        line.thickness = thickness
        line.color = color
        line.attach_to(window)
    window.render()
...
def run_test_fancy_polygon():
    ...
    # ------------------------------------------------------------------
    # TODONE: 9. Implement this TEST function.
...
def fancy_polygon(window, circle, number_of_lines,
    ...
    # ------------------------------------------------------------------
    circle.attach_to(window)
    pt = generate_points_on_circle(circle, number_of_lines)
    for k in range(len(pt)):
        line = rg.Line(pt[k - hops_to_next_point], pt[k])
        line.thickness = thickness
        line.color = color
        line.arrow = 'last'
        line.attach_to(window)
